      ...
      modal: {
        ...
        form: {
          ...
          authModes: {
            ...
            tokenHelp: 'Access Token 和 Refresh Token 二选一。',
            newApiToken: '系统访问令牌',
            newApiTokenHelp: '适用于 Cloudflare Turnstile 导致账号密码无法直连的 New-API 站点。'
          },
          account: '登录账号',
          ...
          newApiAccessToken: '系统访问令牌',
          newApiAccessTokenPlaceholder: '粘贴纯令牌或完整的 Bearer 令牌',
