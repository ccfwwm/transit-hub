      ...
      modal: {
        ...
        form: {
          ...
          authModes: {
            ...
            tokenHelp: 'Provide either an access token or a refresh token.',
            newApiToken: 'System Access Token',
            newApiTokenHelp: 'Use this when Cloudflare Turnstile blocks direct New-API password login.'
          },
          account: 'Account',
          ...
          newApiAccessToken: 'System Access Token',
          newApiAccessTokenPlaceholder: 'Paste either the raw token or the complete Bearer token',
